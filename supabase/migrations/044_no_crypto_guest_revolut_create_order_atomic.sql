-- Remove crypto as a valid payment_method; allow guests to use bank transfer (revolut) for paid checkout.
-- Replaces all create_order_atomic overloads with a single 18-arg function (same signature as 043).
