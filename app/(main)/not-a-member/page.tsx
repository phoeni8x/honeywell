...
export default function NotAMemberPage() {
  ...
  return (
    <div className="mx-auto max-w-xl py-12 text-center">
      ...
      <h1 className="mt-6 font-display text-3xl text-honey-text md:text-4xl">Not a team member yet</h1>
      ...
      <ul className="mt-8 space-y-3 rounded-2xl border border-honey-border bg-surface px-6 py-6 text-left text-sm text-honey-muted dark:bg-surface-dark">
        <li>
          <strong className="text-honey-text">Team members</strong> get discounted prices and can pay with bank transfer or cryptocurrency.
        </li>
        <li>
